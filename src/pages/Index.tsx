      ...
      <main className="container max-w-5xl px-4 py-8 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-1 md:order-2 flex flex-col items-center">
            ...
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden mb-6 border-4 border-white shadow-xl bg-soft-green flex items-center justify-center">
      ...
      >
        <div className="container max-w-5xl px-4 flex items-center justify-between">
          ...
          <a 
            ...
            className="bg-warm-gradient hover:bg-warm-gradient-hover text-black font-bold px-4 py-2 rounded-lg text-sm md:text-base transition-all"
          >
            Join the Challenge →
          </a>
        </div>
